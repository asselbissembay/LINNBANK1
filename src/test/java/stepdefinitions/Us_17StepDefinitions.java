...
public class Us_17StepDefinitions {
    ...
    public void kullaniciGecerliUsernameGirer() {
        us_17page.usernametextbox.sendKeys(ConfigurationReader.getProperty("Administration_username"));

    }

    @And("kullanici gecerli password girer")
    public void kullaniciGecerliPasswordGirer() {
        us_17page.passwordtextbox.sendKeys(ConfigurationReader.getProperty("Administration_username"));
    }
